...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6"><?php echo $gym_name ?> Detail</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="./Gyms.php">Gyms</a></li>
                <li class="breadcrumb-item active text-white"><?php echo $gym_name ?> Detail</li>
            </ol>
        </div>
            ...
            <div class="container py-5">
                <div class="row g-4 mb-5">
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded" style="width: 350px;">
                                    <a href="#">
                                        <img src="../Gym_Dashboard/<?php echo $gym_image ?>" class="img-fluid rounded gym-image" alt="Image">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h4 class="fw-bold mb-3"><?php echo $gym_name ?></h4>
                                <p class="mb-3">Manager Name: <?php echo $manager_name ?></p>
                                <p class="mb-3">Gym Phone: <?php echo $gym_phone ?></p>
                                <p class="mb-3">Gym Email: <?php echo $gym_email ?></p>
                                <p class="mb-3">City Name: <?php echo $gym_city ?></p>
                                ...
                                <a href="./Gym_Subscription.php?gym_id=<?php echo $gym_id ?>" id="buy_item-<?php echo $item_id ?>" class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i class=" me-2 text-primary"></i> Subscribe</a>
...
$images = mysqli_query($con, "SELECT * from gym_images WHERE gym_id = '$gym_id'");

while ($imgloopRow = mysqli_fetch_array($images)) { 
    
    $gym_image_loop = $imgloopRow['image'];
    
    
    
    ?>

                                <div class="border rounded" style="width: 50px;">
                                    <a href="#">
                                        <img src="../Gym_Dashboard/<?php echo $gym_image_loop ?>" class="img-fluid rounded gym-image" alt="Image">
                                    </a>
                                </div>
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                ...
                <h1 class="fw-bold mb-0"><?php echo $gym_name ?> Coaches</h1>
                <div class="vesitable">
                    <div class="owl-carousel vegetable-carousel justify-content-center">
...
$coaches = mysqli_query($con, "SELECT * from gym_coaches WHERE gym_id = '$gym_id' AND active = 1 ORDER BY id DESC");

while ($coachesRow1 = mysqli_fetch_array($coaches)) {

    $coach_id = $coachesRow1['id'];
    $coach_name = $coachesRow1['name'];
    $coach_image = $coachesRow1['image'];
    $coach_email = $coachesRow1['email'];
    $coach_phone = $coachesRow1['phone'];
    $active = $coachesRow1['active'];
    $created_at = $coachesRow1['created_at'];

    ?>
                        <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                                <img src="../Gym_Dashboard/<?php echo $coach_image ?>" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;"><?php echo $gym_Offer_name ?></div>
                            <div class="p-4 pb-0 rounded-bottom">
                                <h4><?php echo $coach_name ?></h4>
                                <p><?php echo $coach_email ?></p>
