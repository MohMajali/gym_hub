...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      ...
                      <td><?php echo $offer_price ?> JDs</td>
                      <td><?php echo $offer_duration ?></td>
                      <th scope="row"><?php echo $created_at ?></th>
                      <td>
                        <a href="./Edit-Offer.php?offer_id=<?php echo $offer_id ?>" class="btn btn-success"
                          >Edit</a
                        >
