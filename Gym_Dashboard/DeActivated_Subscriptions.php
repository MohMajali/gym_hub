...
<html lang="en">
  <head>
    ...
    <title>De-Activated Subscriptions - Gym Hub</title>
  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        <h1>De-Activated Subscriptions</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item">De-Activated Subscriptions</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
                  <?php
$sql1 = mysqli_query($con, "SELECT * from clients_subscriptions WHERE gym_id = '$gym_id' AND status = 'DeActivated' ORDER BY id DESC");
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      ...
                      <a href="./ManageClientSubscriptions.php?subcription_id=<?php echo $subcription_id ?>&status=Subscribed&&page=deactive" class="btn btn-primary">Activate</a>
                      </th>
